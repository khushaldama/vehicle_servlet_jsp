...
public class vehicleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int vfc = Integer.parseInt(request.getParameter("vfc"));
            int vmil = Integer.parseInt(request.getParameter("vmil"));

            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/052", "root", "");

                String q = "insert into vehicle(name,fuel,milage) values(?,?,?)";
